<template>
  ...
  <div class="thumbs-container" ref="thumbsContainer" v-if="thumbsData">
    ...
    >
    <span class="text" :data-cursorsize="$store.state.cursorHover.size" :data-cursoropacity="$store.state.cursorHover.opacity">more</span>
    <span class="arrow" :data-cursorsize="$store.state.cursorHover.size" :data-cursoropacity="$store.state.cursorHover.opacity"></span>
    <span class="arrow copy" :data-cursorsize="$store.state.cursorHover.size" :data-cursoropacity="$store.state.cursorHover.opacity"></span>
    ...
    fetchThumbsPage(_nextPage) {
      ...
      if (this.$route.name === "Search" || this.$route.query.tags ) {
        ...
        ThumbsService.getThumbsPage(this.currentThumbsPage).then((_data) => {
          ...
          this.$store.commit("thumbsLoaded", true);
